...
const html = "<p>We have tried and you finding hell, i may just sacrifie clusless and just trust you will be fine, and when im back in chicago i feel it, goodbye goodbye, you take the man out the city not the city out of the man</p>";
				...
				const frontmatter = {"layout":"../../layouts/ServiceLayout.astro","service":"Soldadura Especializada","description":"Servicios de soldadura en aluminio, acero inoxidable y acero negro, con técnicas avanzadas para proyectos industriales.","image1":{"src":"/service1/concretePump.svg","alt":"test"},"image2":{"src":"/service1/services.webp","alt":"test"},"link":"/services/service3"};
				const file = "C:/Users/carlo/Dev/servicios-jg/src/pages/services/service3.md";
				const url = "/services/service3";
				function rawContent() {
