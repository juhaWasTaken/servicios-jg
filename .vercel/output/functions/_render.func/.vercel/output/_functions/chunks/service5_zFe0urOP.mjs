...
const html = "<p>We have tried and you finding hell, i may just sacrifie clusless and just trust you will be fine, and when im back in chicago i feel it, goodbye goodbye, you take the man out the city not the city out of the man</p>";
				...
				const frontmatter = {"layout":"../../layouts/ServiceLayout.astro","service":"Maquinados de Precisión","description":"Fabricación de piezas especiales utilizando tornos, fresadoras y máquinas CNC para necesidades industriales específicas.","image1":{"src":"/service1/concretePump.svg","alt":"test"},"image2":{"src":"/service1/services.webp","alt":"test"},"link":"/services/service5"};
				const file = "C:/Users/carlo/Dev/servicios-jg/src/pages/services/service5.md";
				const url = "/services/service5";
				function rawContent() {
